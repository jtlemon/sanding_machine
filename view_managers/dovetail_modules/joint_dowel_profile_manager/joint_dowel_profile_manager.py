...
from view_managers.dovetail_modules.joint_profiles.joint_profile_manager import JointProfilesPageManager
from view_managers.dovetail_modules.dowel_profile.dowel_profile_manager import DowelProfileManager
