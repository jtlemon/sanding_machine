...
from view_managers.dovetail_modules.joint_profiles.add_edit_profile_dialog import  AddEditJoinProfile
...
class JointProfilesPageManager(QtWidgets.QWidget):
    ...
    def __init__(self, footer_btn=""):
        ...
        if CURRENT_MACHINE == SupportedMachines.dovetailMachine:
             supported_joint_profiles = dovetail_configurations.DOVETAIL_JOINT_PROFILE_CONFIGURATION
        else:
