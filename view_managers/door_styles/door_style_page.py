...
from view_managers.door_styles.add_edit_door_style_dialog import  AddEditDoorStyleDialog
...
class SandingDoorStylesManager(ProfileAddEditWidget, AbstractOperationWidgetManger):
    ...
    def __init__(self, footer_btn="Door Styles"):
        super(SandingDoorStylesManager, self).__init__(static_configurations.SANDING_DOOR_STYLES_PROFILE,
